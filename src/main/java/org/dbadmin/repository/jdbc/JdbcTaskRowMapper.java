...
import org.dbadmin.model.ExecutionStatus;
import org.dbadmin.model.Task;
import org.springframework.jdbc.core.RowMapper;

public class JdbcTaskRowMapper implements RowMapper<Task> {
  ...
  public Task mapRow(ResultSet rs, int rowNum) throws SQLException {
    ...
    task.setPriorityInRelatedJob(rs.getInt("related_task_priority"));
