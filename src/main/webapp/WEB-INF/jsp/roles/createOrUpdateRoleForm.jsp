	...
	<section id="main" class="p-relative" role="main">
		...
		<section id="content" class="container">
			...
			<div class="block-area" id="job-search">
				...
				<form:form modelAttribute="role" class="form-horizontal"
					id="add-role-form">
					<template:horizInputField label="Role Name" name="role_name" />
					<template:horizInputField label="Prefix" name="role_prefix" />
					<template:horizInputField label="Level" name="role_level" />
