              ...
              <div class="panel panel-default">
                ...
                <div id="collapseOne" class="panel-collapse collapsed active" style="height: 0px;">
                  <div class="panel-body">
                    ...
                    </a> <a class="shortcut tile" href="javascript:;"> <img
                      src="<spring:url value="/resources/images/shortcuts/reports.png" htmlEscape="true" />" alt="">
                      <small class="t-overflow">Edit Con.</small>
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-3">
            ...
            <div class="tile">
              ...
              <div class="listview todo-list sortable ui-sortable">
                ...
                <div class="media" style="position: relative; left: 0px; top: 0px;">
                  <label class="t-overflow" style="top: -4px;"> Application Database </label>
                </div>

                <div class="media" style="position: relative; left: 0px; top: 0px;">
                  <label class="t-overflow" style="top: -2px;"> Data DB </label>
                </div>
              </div>

              <h2 class="tile-title">Favorite Connections</h2>
              ...
              <div class="listview todo-list sortable ui-sortable">
                <div class="media" style="position: relative; left: 0px; top: 0px;">
                  <label class="t-overflow" style="top: -2px;"> OtherDB </label>
                </div>
              </div>
            </div>
            <!-- End of Connections Tile -->
            ...
            <div class="tile">
              ...
              <div class="listview icon-list">
                <div class="media">
                  <div class="media-body">Jobs</div>
                </div>

                <div class="media">
                  <div class="media-body">Business Rules</div>
                </div>

                <div class="media">
                  <div class="media-body">Users</div>
                </div>

                <div class="media">
                  <div class="media-body">Tasks</div>
                </div>
              </div>
            </div>
            <!-- End of Table List -->
          ...
          <div class="col-md-9">
                          ...
                          <div class="vizBox" id="vizBox" style="min-height: 420px;">
                            <div style="position: relative; width: 900px; height: 420px;">
                              ...
                              <div id="d3plus_message" opacity="0"
                                style="display: none; color: rgb(68, 68, 68); font-family: &amp; quot; Helvetica Neue&amp;quot;; font-weight: 200; font-size: 16px; padding: 5px; position: absolute; text-align: center; left: 50%; width: auto; margin-left: 0px; top: 50%; bottom: auto; margin-top: 0px; opacity: 0; background-color: rgb(255, 255, 255);">
                                ...
                                <div class="d3plus_drawer_ui" style="display: inline-block; padding: 5px;">
                                  <div id="d3plus_toggle_visualization_type"
                                    ...
                                    <div class="d3plus_title"
                                      style="display: inline-block; color: rgb(68, 68, 68); font-family: &amp; quot; Helvetica Neue&amp;quot;; font-size: 11px; font-weight: 200; padding: 5px; border: 1px solid transparent;">Visualization
                                      Type</div>
                                    <div class="d3plus_toggle" style="display: inline-block; vertical-align: top;">
                                      <div id="d3plus_button_default1"
                                        style="position: relative; overflow: visible; vertical-align: top; display: inline-block; margin: 0px;">
                                        <div class="d3plus_node"
                                          style="color: rgb(68, 68, 68); border: 1px solid rgb(195, 195, 195); position: relative; margin: 0px; display: inline-block; font-family: &amp; quot; Helvetica Neue&amp;quot;; font-size: 11px; font-weight: 200; letter-spacing: 0px; background-color: rgb(255, 255, 255);">
                                    ...
                                    <div class="d3plus_toggle" style="display: inline-block; vertical-align: top;">
                                      <div id="d3plus_button_default1"
                                        ...
                                        <div class="d3plus_node d3plus_button_active"
                                          style="color: rgba(68, 68, 68, 0.74902); border: 1px solid rgb(195, 195, 195); position: relative; margin: 0px; display: inline-block; font-family: &amp; quot; Helvetica Neue&amp;quot;; font-size: 11px; font-weight: 200; letter-spacing: 0px; background-color: rgb(195, 195, 195);">
                                          <div class="d3plus_button_element d3plus_button_label"
            ...
            <tr>
              <td>
                 ...
                 <a href="3/addfavorite.html" class="btn btn-alt btn-xs m-r-5">Add to Favorite</a> 
                  
                 <a href="3/edit.html" class="btn btn-alt btn-xs m-r-5">Edit</a> 
                  
                 <a href="3/delete.html" class="btn btn-alt btn-xs m-r-5">Delete</a></td>
            </tr>
          </tbody></table>
                </div>
