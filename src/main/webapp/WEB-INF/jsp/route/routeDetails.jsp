		...
		<section id="content" class="container">
			...
			<div class="block-area" id="job-search">
				...
				<table class="table tile">
					<tr>
						<th width="25%"><b>URL</b></th>
						<td><c:out value="${route.url}" /></td>
					</tr>
					<tr>
						<th>ENABLED</th>
						<td><c:out value="${route.access}" /></td>
					</tr>
					<tr>
						<th>PRIORITY</th>
						<td><c:out value="${route.priority}" /></td>
					</tr>
					<tr>
						<td><spring:url value="{routeId}/edit.html" var="editUrl">
							...
							class="btn btn-alt btn-xs m-r-5">Edit</a> <spring:url
								value="{routeId}/delete.html" var="deleteUrl">
								<spring:param name="routeId" value="${route.id}" />
