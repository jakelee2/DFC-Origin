...
<body id="skin-blur-ocean">
	...
	<section id="main" class="p-relative" role="main">
		...
		<section id="content" class="container">
			...
			<!-- Dashboard Body -->
			<div class="block-area" id="route-search">
				<h3 class="block-title">Search</h3>
				<spring:url value="/admin/route" var="formUrl" />
				<form:form modelAttribute="route" action="${fn:escapeXml(formUrl)}"
					method="get" class="form-horizontal" id="search-route-form">
					<fieldset>
