  ...
  <section id="main" class="p-relative" role="main">
    ...
    <section id="content" class="container">
      ...
      <div class="block-area" id="job-search">
        <h3 class="block-title">Outliers Statistics</h3>
          ...
          <div class="btn-group">
            ...
            <ul class="dropdown-menu animated fadeIn">
              ...
              <c:forEach var="item" items="${DbTables}">
                <li><a href="#"><span class="text">${item.name}</span></a></li>
              </c:forEach>
            </ul>
          </div>
        </div>
      ...
      <div class="block-area" id="job-search">
        ...
        <br />
          <div id="outliersDisplay" style="width:210px;"></div>
      </div>
      <!-- End of Dashboard Body -->
    </section>
  </section>
<jsp:include page="./fragments/footStatics.jsp" />
<script src="<spring:url value="/resources/js/outliers.js" htmlEscape="true" />"></script>
</body>
</html>
