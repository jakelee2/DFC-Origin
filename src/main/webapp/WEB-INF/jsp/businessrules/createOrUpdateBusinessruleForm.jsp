		...
		<section id="content" class="container">
			...
			<div class="block-area" id="job-search">
				<h3 class="block-title">
					<c:if test="${businessrule['new']}">New </c:if>
					Business Rule
				</h3>
				<form:form modelAttribute="businessrule" id="add-businessrule-form">
					...
					<template:horizInputField label="REST connection"
						name="restconnection" />
					<p></p>
					<div class="form-actions">
						<c:choose>
							<c:when test="${businessrule['new']}">
