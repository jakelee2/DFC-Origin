	...
	<section id="main" class="p-relative" role="main">
		...
		<section id="content" class="container">
			...
			<div class="block-area" id="job-search">
				...
				<spring:url value="/businessrules.html" var="formUrl" />
				<form:form modelAttribute="businessrule"
					action="${fn:escapeXml(formUrl)}" method="get"
					class="form-horizontal" id="search-businessrule-form">
					<fieldset>
