  ...
  <section id="main" class="p-relative" role="main">
    ...
    <section id="content" class="container">
      ...
      <div class="block-area" id="job-search">
        <h3 class="block-title">Business Rules</h3>
        <datatables:table id="businessrules" data="${selections}" row="businessrule" cssClass="table tile"
          cssStyle="true" pageable="false" info="false" export="csv">
          <datatables:column title="Name" display="html">
            ...
            <a href="${fn:escapeXml(businessruleUrl)}"><c:out value="${businessrule.name}" /></a>
          </datatables:column>
          <datatables:column title="Name" display="pdf">
            <c:out value="${businessrule.name}" />
          </datatables:column>
