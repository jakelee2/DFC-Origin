  ...
  <section id="main" class="p-relative" role="main">
    ...
    <section id="content" class="container">
      ...
      <div class="block-area" id="job-search">
        ...
        <spring:url value="/tasks.html" var="formUrl" />
        <form:form modelAttribute="task" action="${fn:escapeXml(formUrl)}" method="get" class="form-horizontal"
          id="search-task-form">
          <fieldset>
            <div class="control-group" id="name">
              <form:input path="name" size="30" maxlength="80" class="form-control m-b-10" placeholder="Search..." />
